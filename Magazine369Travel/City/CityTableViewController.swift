...
//        
//        let xib = UINib(nibName: testCityTableViewCell.identifier, bundle: nil)
//        tableView.register(xib, forCellReuseIdentifier: testCityTableViewCell.identifier)
//        
...
//        
//        let cell = tableView.dequeueReusableCell(withIdentifier: testCityTableViewCell.identifier, for: indexPath) as! testCityTableViewCell
//        
